...
@Component({
  selector: "app-candidate-grid-card",
  templateUrl: "./candidate-grid-card.component.html",
  styleUrls: ["./candidate-grid-card.component.scss"],
})
export class CandidateGridCardComponent implements OnInit {
  ...
  sendCompletionMail(candidate: Candidate) {
    console.log("complete your submission please");
  }
