...
@Component({
  selector: "app-update-profile-candidate",
  templateUrl: "./update-profile-candidate.component.html",
  styleUrls: ["./update-profile-candidate.component.scss"],
})
export class UpdateProfileCandidateComponent {
  userData: any;
  candidate!: Candidate;
  ...
  ngOnInit(): void {
    ...
    this.candidateService
      ...
      .subscribe((res) => {
        console.log("Data back from server ", res);
        this.candidate = res;
        ...
        this.imagePreview = this.candidate.imagePath;
        if (res.educations) {
          this.educationArray = res.educations;
        }
        if (res.certifications) {
          this.certificationArray = res.certifications;
        }
        if (res.experiences) {
          this.experienceArray = res.experiences;
        }
        console.log("CURRENT CANDIDATE ---- ", this.candidate);
      });
    /**
     * Form Validation
     */
