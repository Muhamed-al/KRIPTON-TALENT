...
def recommend_candidates(job_id, number_of_candidates):
    ...
    candidates_df = pd.DataFrame(candidates,
                                 columns=['id', 'email', 'first_name', 'last_name', 'image_path', 'phone', 'country',
                                          'designation', 'skills'])
    ...
    for index, row in top_resumes_df.iterrows():
        ...
        candidates_list.append(
            f"{candidate_id},{first_name},{last_name},{imagePath},{phone},{country},{email},{designation},{match_percentage}")
    ...
    for i in range(len(candidates_list)):
        ...
        pro_key = ['id', 'first_name', 'last_name', 'imagePath', 'phone', 'country', 'email', 'designation', 'score',
                   'skills']
