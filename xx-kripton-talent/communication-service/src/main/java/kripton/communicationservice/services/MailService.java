...
public class MailService implements IMailService{
     ...
     private static String completionTemplate = "<body data-new-gr-c-s-loaded=\"14.1108.0\" style=\"width:100%;font-family:arial, 'helvetica neue', helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0\">\n" +
             ...
             "</tr>\n" +
             "<tr>\n" +
             "<td align=\"left\" style=\"padding:0;Margin:0;padding-top:10px;padding-bottom:10px\"><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#a64d79;font-size:16px\">Hello, *|FNAME|* ! We wanted to mention that you did not complete you profile.</p><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#a64d79;font-size:16px\">If you have sometime complete it , that will make it easier for us to find the best opportunity for you .</p><a href=\"http://localhost:4200/ems/candidates/complete-profile/*|CID|*\" style=\"display: inline-block; padding: 10px 20px; background-color: #0b5394; color: white; text-align: center; text-decoration: none; border: none; border-radius: 4px; cursor: pointer; margin-left: 200px; margin-top: 20px;\">Complete Your Data</a>\r\n"
             + "\r\n"
             + "<p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#a64d79;font-size:16px\"><br></p><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#a64d79;font-size:16px\">Cordially ,<br>Team Kripton .</p></td>\n" +
             "</tr>\n" +
             "</table></td>\n" +
             "</tr>\n" +
             "</table></td>\n" +
    ...
    public void completionNotification(String data) {
        ...
        try{
            ...
            String body =completionTemplate.replace ("*|FNAME|*",candidate.getFirstName ())
            							   .replace("*|CID|*", String.valueOf(candidate.getId()));
